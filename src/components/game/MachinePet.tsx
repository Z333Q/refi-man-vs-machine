...
const POSTURE_NOTE: Record<ReturnType<typeof posture>, string> = {
  BENCH: 'BUILT, NOT COMPILED. IT HAS NOT STOOD UP YET.',
  STANDING: 'COMPILED AND RUNNING INSIDE ITS LIMITS.',
  BRACED: 'BRACED. RISK BUDGET IS RUNNING HOT — THE STANCE IS THE MACHINE WORKING, NOT FAILING.',
  HALTED: 'HALTED BY ITS OWN GUARDRAIL. THIS IS A SUCCESS CONDITION, NOT A FAULT.',
};
