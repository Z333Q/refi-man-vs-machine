...
export default function TitleScreen({ onEnter }: Props) {
  ...
  return (
    <div className="terminal-screen screen-fit flex flex-col select-none">
      ...
      {/* Primary action — same territory as every later screen: the premise
          is above, the action that advances state is centred below it. The
          card itself also starts the game (arcade attract convention). */}
